(() => {
    ...
    class Aoc42 extends HTMLElement {
        constructor() {
            super();
        ...
        run(input) {
            ...
            this.shadowRoot.querySelector("p").textContent = `Output: ${globalCountRemoved}`;
        }
    ...
    customElements.define("aoc-42", Aoc42);
})();
