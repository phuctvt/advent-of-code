...
(() => {
    ...
    class Aoc81 extends HTMLElement {
        /**
        ...
        run(input) {
            ...
            connections.forEach((connection, index) => {
                ...
                if (existingBagIndex1 === existingBagIndex2) {
                    return;
                }
                if (existingBagIndex1 !== -1 && existingBagIndex2 !== -1) {
                ...
                if (existingBagIndex1 !== -1) {
                    const bag1 = bags[existingBagIndex1];
                    bag1.push(connection.point2);
                    return;
                }
                if (existingBagIndex2 !== -1) {
                    const bag2 = bags[existingBagIndex2];
            ...
            bags.sort((a, b) => b.length - a.length)
    ...
    customElements.define("aoc-81", Aoc81);
})();
